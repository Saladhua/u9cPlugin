...
namespace YY.U9.Cust.LI.AppPlugIn
{
    ...
    class HxRAMSubsciber : UFSoft.UBF.Eventing.IEventSubscriber
    {
        ...
        public void Notify(params object[] args)
        {
            ...
            if (rMA.SysState == UFSoft.UBF.PL.Engine.ObjectState.Updated && rMA.Status.Value == 2)
            {
                ...
                formData.Append("\"planDate\":\"" + rMA.RequireDate.ToString("yyyy-MM-dd") + "\",");
                ...
                logger.Error("RMA新增传出数据：" + formSendData.ToString());
            ...
            if (rMA.SysState == UFSoft.UBF.PL.Engine.ObjectState.Deleted)
            {
                //string appid = TokenManager.appid;
                ...
                logger.Error("RMA删除传出数据：" + formSendData.ToString());
                ...
                logger.Error("RMA删除返回数据：" + responseText.ToString());
