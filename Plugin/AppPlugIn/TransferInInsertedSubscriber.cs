...
namespace YY.U9.Cust.LI.AppPlugIn
{
    ...
    class TransferInInsertedSubscriber : UFSoft.UBF.Eventing.IEventSubscriber
    {
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(TransferInInsertedSubscriber));
